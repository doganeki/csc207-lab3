...
public class Main {
    ...
    public static void runProgram(Translator translator) {
        while (true) {
            ...
            // TO-DO CheckStyle: The String "quit" appears 3 times in the file.
    ...
    private static String promptForLanguage(Translator translator, String country) {
        ...
        // TO-DO Task: replace the line below so that we sort the languages alphabetically and print them out; one per line
